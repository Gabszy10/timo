...
<head>
    ...
    <title>About | St. Helena Parish</title>
    <meta name="description" content="Learn about the history, mission, and pastoral team of St. Helena Parish.">
...
<body>
    ...
    <div class="bradcam_area breadcam_bg">
        <h3>About St. Helena Parish</h3>
    </div>

    <section class="about_area pt-120 pb-90">
        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="about_info">
                        <div class="section_title mb-20px">
                            ...
                            <h3>More than 100 years of faith and service</h3>
                        </div>
                        <p>Founded in 1912 by missionary priests, St. Helena Parish began as a small worshiping community serving immigrant families. Over the decades, the parish has grown alongside the city—building a church and school, establishing outreach ministries, and forming generations of faithful disciples. Today, we continue that legacy by welcoming all who seek Christ and companionship on their spiritual journey.</p>
                        <p>Our community gathers for Mass, prayer, and fellowship throughout the week. We celebrate the sacraments with reverence and joy, and we accompany families through every season of life—from baptism to marriage, from healing to memorials.</p>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="about_main_info pt-0 pb-90">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="single_about_info">
                        <h3>Our Mission</h3>
                        <p>We, the people of St. Helena Parish, are called to be a welcoming Catholic community. We worship God through Word and Sacrament, form disciples through prayer and education, and serve our neighbors through justice and charity.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="single_about_info">
                        <h3>Our Vision</h3>
                        <p>Rooted in the Gospel, we envision a parish that radiates the love of Christ—nurturing families, empowering youth, and reaching out to the vulnerable. We strive to be a beacon of hope where every person is seen, known, and loved.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="team_area pt-0 pb-120">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-70">
                        <span>Our Pastoral Team</span>
                        <h3>Meet the ministers who serve our parish</h3>
                    </div>
                </div>
            </div>
            <div class="row">
